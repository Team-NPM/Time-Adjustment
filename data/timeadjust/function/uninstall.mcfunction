...
tellraw @a [{"translate": "Run ","color": "white","bold": false},{"translate": "/datapack disable \"file/Day-Adjustment-R2.0.6.zip\"","color": "red","bold": false,"clickEvent": {"action": "suggest_command","value": "/datapack disable \"file/Time-Adjustement-R2.0.6.zip\""},"hoverEvent": {"action": "show_text","contents": [{"translate": "Click to run (must have sufficient permissions)"}]}},{"translate": " to finish uninstallation","color": "white","bold": false}]
