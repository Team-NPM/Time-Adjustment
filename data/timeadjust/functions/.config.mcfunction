...
# warn-off infinite-recursion
  tellraw @s [{"text": "[", "color": "yellow"}, {"text": "-05", "color": "red", "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/decrease5"}}, {"text": "] [", "color": "yellow"}, {"text": "-01", "color": "red", "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/decrease1"}}, {"text": "] ", "color": "yellow"}, {"text": "manual", "color": "yellow", "clickEvent": {"action": "suggest_command", "value": "/function timeadjust:config/setcyclelength {hours: LENGTH_IN_HOURS, minutes: LENGTH_IN_MINUTES}"}}, {"text": " [", "color": "yellow"}, {"text": "+01", "color": "green", "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/increase1"}}, {"text": "] [", "color": "yellow"}, {"text": "+05", "color": "green", "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/increase5"}}, {"text": "]", "color": "yellow"}]
  # warn-off infinite-recursion
    tellraw @s [{"text": "[", "color": "yellow", "underlined": false}, {"text": "-60", "color": "red", "underlined": false, "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/decrease60"}}, {"text": "] [", "color": "yellow", "underlined": false}, {"text": "-20", "color": "red", "underlined": false, "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/decrease20"}}, {"text": "] ", "color": "yellow", "underlined": false}, {"text": "adjust", "color": "yellow", "underlined": true, "clickEvent": {"action": "suggest_command", "value": "/function timeadjust:config/setcyclelength {hours: LENGTH_IN_HOURS, minutes: LENGTH_IN_MINUTES}"}}, {"text": " [", "color": "yellow", "underlined": false}, {"text": "+20", "color": "green", "underlined": false, "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/increase20"}}, {"text": "] [", "color": "yellow", "underlined": false}, {"text": "+60", "color": "green", "underlined": false, "clickEvent": {"action": "run_command", "value": "/function timeadjust:config/increase60"}}, {"text": "]", "color": "yellow", "underlined": false}]
