...
# Retreive backup data in case of update
  execute if score B.TimeAdjust B.TimeAdjust matches 1 run function timeadjust:loadbackup
...
# Begin ticking
  execute if score TimeAdjust.DoDaylightCycle TimeAdjust matches 1 run schedule function timeadjust:tick 1t
